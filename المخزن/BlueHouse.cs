...
namespace المخزن
{
    public partial class BlueHouse : Form
    {
        public BlueHouse()
        {
            InitializeComponent();
        ...
        private void BlueHouse_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from BlueHouse";
        ...
        {
            Con.Open();
            String query = "insert into BlueHouse values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO BlueHouse (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
