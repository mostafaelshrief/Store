...
{    
    ...
    public class DGVPrinter
    {
        ...
        public DGVPrinter()
        {
            ...
            PrintMargins = new Margins(50, 50, 30, 30);
            ...
            buildstringformat(ref titleformat, null, StringAlignment.Center, StringAlignment.Center,
                StringFormatFlags.NoWrap | StringFormatFlags.LineLimit | StringFormatFlags.MeasureTrailingSpaces, StringTrimming.Word);
            buildstringformat(ref subtitleformat, null, StringAlignment.Center, StringAlignment.Center,
                StringFormatFlags.NoWrap | StringFormatFlags.FitBlackBox | StringFormatFlags.MeasureTrailingSpaces, StringTrimming.Word);
            ...
            StringTrimming trim)
        {
            ...
            if (null != controlstyle)
            {
                ...
                else if (cellalign.ToString().Contains("Bottom")) format.LineAlignment = StringAlignment.Near;
            }
        }
