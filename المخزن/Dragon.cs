...
namespace المخزن
{
    public partial class Dragon : Form
    {
        ...
        {
            Con.Open();
            String query = "insert into Dragon values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO Dragon (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
