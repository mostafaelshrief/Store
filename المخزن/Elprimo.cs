...
namespace المخزن
{
    public partial class Elprimo : Form
    {
        public Elprimo()
        {
            InitializeComponent();
        ...
        private void Elprimo_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from alPrimo";
        ...
        {
            Con.Open();
            String query = "insert into alPrimo values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO alPrimo (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
