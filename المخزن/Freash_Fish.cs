...
namespace المخزن
{
    public partial class Freash_Fish : Form
    {
        public Freash_Fish()
        {
            InitializeComponent();
        ...
        private void Freash_Fish_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from FreashFish";
        ...
        {
            Con.Open();
            String query = "insert into FreashFish values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO FreashFish (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
