...
namespace المخزن
{
    public partial class Indebtedness_Ketchen : Form
    {
        public Indebtedness_Ketchen()
        {
            InitializeComponent();
        }
        ...
        private void Indebtedness_Schedule_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                Con.Open();
                String query = "insert into ketchenTbl values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
                SqlCommand cmd = new SqlCommand("INSERT INTO ketchenTbl (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
        ...
        {
            Con.Open();
            String query = "select * from ketchenTbl";
