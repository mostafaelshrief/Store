...
namespace المخزن
{
    public partial class Indebtedness_Resturant : Form
    {
        public Indebtedness_Resturant()
        {
            InitializeComponent();
        }
        ...
        private void Indebtedness_Resturant_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from ResturantTbl";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            dgvprinter.Title = " جدول مديونيه المطعم";
        ...
        {
            Con.Open();
            String query = "insert into ResturantTbl values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO ResturantTbl (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
