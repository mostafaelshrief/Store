...
namespace المخزن
{
    public partial class Indebtedness_Stuff_Resturant : Form
    {
        public Indebtedness_Stuff_Resturant()
        {
            InitializeComponent();
        }
        ...
        {
            Con.Open();
            String query = "select * from StuffTbl";
        ...
        {
            Con.Open();
            String query = "insert into StuffTbl values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO StuffTbl (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            dgvprinter.Title = " جدول مديونيه الاستاف";
        ...
        private void Indebtedness_Stuff_Resturant_Load(object sender, EventArgs e)
        {
            populate();
        }
    }
