...
namespace المخزن
{
    public partial class Indebtedness_yacht : Form
    {
        public Indebtedness_yacht()
        {
            InitializeComponent();
        }
        ...
        private void Indebtedness_yacht_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from YachtTbl";
        ...
        {
            Con.Open();
            String query = "insert into YachtTbl values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO YachtTbl (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
