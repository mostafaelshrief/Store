...
namespace المخزن
{
    public partial class Mirage : Form
    {
        ...
        {
            Con.Open();
            String query = "select * from Mirage";
        ...
        {
            Con.Open();
            String query = "insert into Mirage values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO Mirage (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
