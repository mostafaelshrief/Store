...
namespace المخزن
{
    public partial class Omar : Form
    {
        ...
        private void Omar_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "insert into omar values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO omar (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
