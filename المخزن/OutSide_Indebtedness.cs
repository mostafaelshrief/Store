...
namespace المخزن
{
    public partial class OutSide_Indebtedness : Form
    {
        public OutSide_Indebtedness()
        {
            InitializeComponent();
        }
        ...
        {
            Con.Open();
            String query = "insert into OutSideTbl values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO OutSideTbl (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            dgvprinter.Title = " جدول مديونيه المركب";
        ...
        private void OutSide_Indebtedness_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from OutSideTbl";
