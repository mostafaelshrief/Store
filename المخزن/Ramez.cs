...
namespace المخزن
{
    public partial class Ramez : Form
    {
        public Ramez()
        {
            InitializeComponent();
        ...
        private void Ramez_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from Ramez";
        ...
        {
            Con.Open();
            String query = "insert into Ramez values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO Ramez (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
