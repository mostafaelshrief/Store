...
namespace المخزن
{
    public partial class SeaView : Form
    {
        public SeaView()
        {
            InitializeComponent();
        ...
        private void SeaView_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from Seaview";
        ...
        {
            Con.Open();
            String query = "insert into SeaView values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO SeaView (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
