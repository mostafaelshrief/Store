...
namespace المخزن
{
    public partial class Shark : Form
    {
        ...
        private void Shark_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from Shark";
        ...
        {
            Con.Open();
            String query = "insert into Shark values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO Shark (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
