...
namespace المخزن
{
    public partial class plante : Form
    {
        public plante()
        {
            InitializeComponent();
        ...
        private void plante_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from Palnte";
        ...
        {
            Con.Open();
            String query = "insert into Palnte values(N'" + dateTimePicker1.Value.ToString() + "','" + daf3.Text + "','" + dayen.Text + "','" + daf23Lbl.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO Palnte (اليوم,الدين,الدفع,اللى_دفع) VALUES " +
